...
source_dir = "_my_projects/swatches/two_color_brioche/" # this is the folder the .ks file is located in. Make sure this path ends with a /
title = "two_color_brioche" # this is the name of the project and .ks file
version = ""
