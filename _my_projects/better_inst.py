...
source_dir = "_my_projects/swatches/twisted_loop/" # this is the folder the .ks file is located in. Make sure this path ends with a /
title = "twisted_loop" # this is the name of the project and .ks file
version = ""
