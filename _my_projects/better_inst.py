...
source_dir = "_my_projects/brioche/branching/" # this is the folder the .ks file is located in. Make sure this path ends with a /
title = "branching" # this is the name of the project and .ks file
version = ""
